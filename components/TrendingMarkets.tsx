  ...
  return (
    <div className="bg-card rounded-xl p-8 shadow-sm border border-border">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-2xl font-bold text-primary">Trending Markets</h2>
      ...
      <div className="relative overflow-hidden py-1">
        ...
        >
          ...
          <div className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-card via-card/80 to-transparent z-10 pointer-events-none" />
          
          {/* Right gradient overlay */}
          <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-card via-card/80 to-transparent z-10 pointer-events-none" />
              ...
              return (
                <CarouselItem key={market._id} className="pl-4 basis-full md:basis-[45%] lg:basis-[38%] py-1">
                  <Card 
                    ...
                    className="cursor-pointer hover:shadow-lg transition-all duration-300 border border-border bg-card hover:border-border h-56 flex flex-col"
                  >
                    <CardContent className="px-4 pt-4 pb-5 flex flex-col h-full justify-between">
                      <div>
                        ...
                        <h3 className="font-bold text-primary mb-2 line-clamp-1 text-sm leading-tight">
                          {market.title}
                        </h3>
